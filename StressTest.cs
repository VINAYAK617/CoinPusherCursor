...
internal static class StressTest
{
    internal static void Run()
    {
        ...
        {
            ("01 minimal", new MathInput { Targets=new Dictionary<int,int>{{1,5},{2,4}}, BaseSpins=2 }),
            ...
            ("04 1W+1F", new MathInput { Targets=new Dictionary<int,int>{{1,20},{2,15}}, BaseSpins=8,
                Required=new Dictionary<string,int>{{"WHEEL",1},{"FLUSH",1}} }),
            ("05 2W+2F", new MathInput { Targets=new Dictionary<int,int>{{1,40},{2,30}}, BaseSpins=14,
                Required=new Dictionary<string,int>{{"WHEEL",2},{"FLUSH",2}} }),
            ("06 multiW", new MathInput { Targets=new Dictionary<int,int>{{1,50},{2,20}}, BaseSpins=12,
                Required=new Dictionary<string,int>{{"WHEEL",2}} }),
            ("07 xspin", new MathInput { Targets=new Dictionary<int,int>{{1,12},{2,10}}, BaseSpins=6,
                Required=new Dictionary<string,int>{{"EXTRA_SPIN",1}} }),
            ("08 prup", new MathInput { Targets=new Dictionary<int,int>{{1,18},{2,12}}, BaseSpins=7,
                Required=new Dictionary<string,int>{{"PRIZE_UPGRADE",1}}, PrizeTiers=new Dictionary<int,int>{{1,2}} }),
            ("09 prup+F", new MathInput { Targets=new Dictionary<int,int>{{1,20},{2,15}}, BaseSpins=8,
            ...
            ("11 4W", new MathInput { Targets=new Dictionary<int,int>{{1,60},{2,50},{3,35},{4,20}}, BaseSpins=15,
                Required=new Dictionary<string,int>{{"WHEEL",4}} }),
            ("12 5sym", new MathInput { Targets=new Dictionary<int,int>{{1,30},{2,25},{3,20},{4,15},{5,10}}, BaseSpins=18, MaxSym=10 }),
            ("13 prup multisym", new MathInput { Targets=new Dictionary<int,int>{{2,20},{5,20},{3,20},{4,20},{6,20}}, BaseSpins=9,
                Required=new Dictionary<string,int>{{"WHEEL",2},{"FLUSH",2},{"PRIZE_UPGRADE",1}}, PrizeTiers=new Dictionary<int,int>{{2,3}}, MaxSym=10 }),
            ("14 2xXSPIN chain", new MathInput { Targets=new Dictionary<int,int>{{2,20},{5,20},{3,20},{4,20},{6,20}}, BaseSpins=9,
                Required=new Dictionary<string,int>{{"WHEEL",2},{"FLUSH",2},{"PRIZE_UPGRADE",1},{"EXTRA_SPIN",2}}, PrizeTiers=new Dictionary<int,int>{{2,3}}, MaxSym=10 }),
            ("15 prup tier2 single-sym", new MathInput { Targets=new Dictionary<int,int>{{1,20}}, BaseSpins=10,
                Required=new Dictionary<string,int>{{"PRIZE_UPGRADE",2}}, PrizeTiers=new Dictionary<int,int>{{1,2}} }),
            ("16 prup tier2 multi-sym", new MathInput { Targets=new Dictionary<int,int>{{1,20},{2,20},{3,20},{4,25},{5,25},{6,30}}, BaseSpins=14,
                Required=new Dictionary<string,int>{{"PRIZE_UPGRADE",2}}, PrizeTiers=new Dictionary<int,int>{{1,2},{3,1}}, MaxSym=10 }),
            ("17 real 6-symbol pool, 4 wins", new MathInput
                { Targets=new Dictionary<int,int>{{1,20},{2,20},{3,20},{4,25}}, BaseSpins=14 }),
        };
